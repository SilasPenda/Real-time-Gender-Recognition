...
def callback(frame):
    ...
    faces = face_cascade.detectMultiScale(image = img, scaleFactor = 1.1, minNeighbors = 3)
    ...
    if choice == 'Home':
        ...
        html_temp4 = """
                             		...
                             		<h4 style="color:white;text-align:center;">This Application is developed by: Penda Silas, Ogunjimi Ayobami, Ebenezer Acquah, 
                                                                                Olabisi Oluwale Anthony, Raphael Okai, Oluwatimilehin Folarin using  Streamlit Framework,  
                                                                                Opencv, Tensorflow and Keras library for demonstration purpose. </h4>
